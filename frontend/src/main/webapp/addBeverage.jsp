...
<div class="form-style-5">
    <%-------------------       expression -------%>
    <form action="<%= request.getContextPath() %>/beverages" method="post">
        <fieldset>
            ...
            <select id="incentive" name="incentive">
                <optgroup label="Incentives">
                    ...
                    %>
                    <option value="<%= incentive.getId() %>"><%= incentive.getName() %> -
                        (<%= incentive instanceof PromotionalGift ? "Promotional" : "Trial" %>)
                    </option>
                    <% } %>
                </optgroup>
